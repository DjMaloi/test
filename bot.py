...
Если точного совпадения нет — скажи: "Не нашёл точного решения, мои Знания пока что на стадии наполнения. Опишите проблему более подробнее или обратись администраторам группы (Напоминаем что для проблем с киосками создан специальный ТГ бот @astra_carry_bot.)"
