...
# В начале handle_message, после raw_text = ...
    CRITICAL_MISMATCHES = {
        "касса": ["киоск", "КСО", "сканер", "принтер чеков"],
        "киоск": ["касса", "терминал оплаты", "онлайн-касса"],
        "смена": ["смена", "смeна"],  # опечатки
    }

# Проверим, не противоречит ли найденный ответ запросу
