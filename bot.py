...
Если точного совпадения нет — скажи: "Не нашёл точного решения. Опишите подробнее или обратись к модератору или администраторам группы (для проблем с киосками создан специальный ТГ бот @astra_carry_bot."
