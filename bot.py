...
def preprocess(text: str) -> str:
    ...
    synonyms = {
        r'\bкд\b': 'касса',                        # КД → касса
        r'\bкасса доставки\b': 'касса',           # касса доставки → касса
        r'\bкасса ресторана\b': 'касса',      # касса ресторана → касса
        r'\bкр\b': 'касса',                    # КР → касса
        #r'\bксо\b': 'касса',                      # КСО → касса
        #r'\bсамообслуживани[еяю]\b': 'касса',     # самообслуживание → касса
        #r'\bтерминал самообслуживания\b': 'касса',
        r'\bфискальный регистратор\b': 'касса',
